...
/*document.querySelector('.container-carousel-clients-feedback .previous).addEventListener('click', prevSlide);
document.querySelector('.container-carousel-clients-feedback .next).addEventListener('click', nextSlide);*/
renderSlides();
